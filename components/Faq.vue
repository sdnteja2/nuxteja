		...
		<div class="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
			...
			<div class="space-y-4">
				<details class="w-full border rounded-lg">
					<summary class="px-4 py-6 focus:outline-none focus-visible:ring-sky-400">Ex orci laoreet egestas sapien magna egestas scelerisque?</summary>
				...
				<details class="w-full border rounded-lg">
					<summary class="px-4 py-6 focus:outline-none focus-visible:ring-sky-400">Lorem at arcu rutrum viverra metus sapien venenatis lobortis odio?</summary>
				...
				<details class="w-full border rounded-lg">
					<summary class="px-4 py-6 focus:outline-none focus-visible:ring-sky-400">Eleifend feugiat sollicitudin laoreet adipiscing bibendum suscipit erat?</summary>
